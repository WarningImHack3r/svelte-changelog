<script lang="ts">
	...
	import type { CategorizedPackage } from "#lib/server/package-discoverer.js";
	import { type PackageSettings, type Prettify, expandStates, releasesTypes } from "#lib/types.js";
