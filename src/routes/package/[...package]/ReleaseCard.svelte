...
<Accordion.Item
	...
	class={[
		"scroll-mt-20 rounded-md border-b-0 bg-background shadow-lg outline outline-transparent transition-colors duration-300 *:data-accordion-content:rounded-b-md *:data-accordion-content:bg-accent/30 data-[state=open]:outline-muted-foreground/20",
		{
			...
			"relative mb-2.5 ring-3 ring-destructive before:absolute before:-top-7.5 before:left-1/2 before:-z-10 before:w-[98%] before:-translate-x-1/2 before:rounded-t-lg before:border-2 before:border-destructive before:bg-destructive/25 before:px-2 before:pb-1.5 before:text-center before:text-nowrap before:text-white before:content-['This_release_likely_contains_security_fixes._Upgrade_as_soon_as_possible!']":
				isLikelySecurityFix,
			...
			"mt-10": isLikelySecurityFix && index > 0,
