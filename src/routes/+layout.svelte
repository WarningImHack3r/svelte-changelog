<script lang="ts">
	...
	import { authorVCSProfile, authorVCSUsername, siteName, siteRepo } from "#lib/properties.js";
	import type { Entries } from "#lib/types.js";
	...
	import { derror } from "#lib/logging.js";
	import { waitFor } from "#lib/reactivity.svelte.js";
