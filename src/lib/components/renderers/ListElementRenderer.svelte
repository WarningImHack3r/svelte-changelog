...
>
	...
	{#if allLinks.length}
		<Button
			...
			variant="link"
			class="ml-2 inline-flex! h-auto p-0! transition-[translate,opacity] duration-300 group-hover:translate-x-0 group-hover:opacity-100 md:pointer-events-none md:ml-4 md:-translate-x-2 md:opacity-0 md:group-hover:pointer-events-auto lg:mr-8"
		>
			Open details
